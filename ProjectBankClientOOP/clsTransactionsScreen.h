...
{
private:
    enum enTransactionsMenueOptions { eDeposit = 1, eWithraw, eTotalBalance, eTransfer, eTransferLog, eBackToMenu };
    ...
    static void _PerformTransactionsMenueOption(enTransactionsMenueOptions TransactionsMenueOption)
    {
        ...
        case enTransactionsMenueOptions::eWithraw:
        {
            system("cls");
            _ShowWithdrawScreen();
            _GoBackToTransactionsMenue();
        ...
        case enTransactionsMenueOptions::eBackToMenu:
        {
